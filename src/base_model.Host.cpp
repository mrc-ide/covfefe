...
Host::Host(int max_innoculations) {
  ...
  // initialise innoculation objects
  innoc_status = vector<Status>(max_innoculations);
  innoc_next_status = vector<Status>(max_innoculations);
  innoc_status_update_time = vector<int>(max_innoculations);
  innoc_infective_status = vector<Status>(max_innoculations);
  innoc_next_infective_status = vector<Status>(max_innoculations);
  innoc_infective_status_update_time = vector<int>(max_innoculations);
...
void Host::reset(int ID, int deme, int birth_day, int death_day) {
  ...
  // innoculation objects
  fill(innoc_status.begin(), innoc_status.end(), Inactive);
  fill(innoc_next_status.begin(), innoc_next_status.end(), Null);
  fill(innoc_status_update_time.begin(), innoc_status_update_time.end(), 0);
  fill(innoc_infective_status.begin(), innoc_infective_status.end(), Inactive);
  fill(innoc_next_infective_status.begin(), innoc_next_infective_status.end(), Null);
  fill(innoc_infective_status_update_time.begin(), innoc_infective_status_update_time.end(), 0);
...
void Host::summary() {
  ...
  print_vector(innoc_status);
  print_vector(innoc_next_status);
  print_vector(innoc_status_update_time);
  print_vector(innoc_next_infective_status);
  print_vector(innoc_infective_status_update_time);
  print("");
}
